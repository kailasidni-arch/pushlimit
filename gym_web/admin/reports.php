    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <span style="font-size:12px; color:rgba(255,255,255,0.4); background:rgba(255,255,255,0.08); padding:4px 10px; border-radius:6px;">GROUP BY + HAVING</span>
            </div>
            <div style="padding: 12px 24px; background:var(--black-4); border-bottom:1px solid rgba(255,255,255,0.08);">
            ...
            <div class="table-responsive">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td colspan="3" style="text-align:center; color:rgba(255,255,255,0.3);">No data found.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <span style="font-size:12px; color:rgba(255,255,255,0.4); background:rgba(255,255,255,0.08); padding:4px 10px; border-radius:6px;">INNER JOIN</span>
            </div>
            <div style="padding: 12px 24px; background:var(--black-4); border-bottom:1px solid rgba(255,255,255,0.08);">
                <code style="font-size:12px; color:rgba(255,255,255,0.6);">
        ...
        <div style="display:grid; grid-template-columns: 1fr 1fr; gap:24px;">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <span style="font-size:12px; color:rgba(255,255,255,0.4); background:rgba(255,255,255,0.08); padding:4px 10px; border-radius:6px;">SUBQUERY</span>
                </div>
                <div style="padding: 10px 24px; background:var(--black-4); border-bottom:1px solid rgba(255,255,255,0.08);">
                    <code style="font-size:11px; color:rgba(255,255,255,0.6);">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <span style="font-size:12px; color:rgba(255,255,255,0.4); background:rgba(255,255,255,0.08); padding:4px 10px; border-radius:6px;">GROUP BY</span>
                </div>
                <div style="padding: 10px 24px; background:var(--black-4); border-bottom:1px solid rgba(255,255,255,0.08);">
                    <code style="font-size:11px; color:rgba(255,255,255,0.6);">
